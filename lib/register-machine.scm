; original: sicp/register_machine.scm at master · hagino3000/sicp
; https://github.com/hagino3000/sicp/blob/master/chap5/register_machine.scm

; For q5.14, q5.15
; スタックの計測とinstruction countingを追加した計算機
(define true #t)
(define false #f)
...
(define (instruction-execute-proc inst)
 (cdr inst))
